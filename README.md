...
- 🎯 Foco atual: me tornar **desenvolvedor front-end**
- 💡 Interessado em tecnologia, programação e inclusão digital
- 👨‍👩‍👦‍👦 Pai do Daniel e do Heitor ❤️ Casado com Pâmela desde 2016 🎮 Gamer nas horas vagas
...
> 📌 Estudando **React** com prioridade no momento.

## 🛠️ Noções de back-end (usadas no projeto Fluxy Home)
...
- Me tornar um desenvolvedor **front-end** sólido, com domínio de React
- Criar interfaces acessíveis, bem projetadas e centradas no usuário
